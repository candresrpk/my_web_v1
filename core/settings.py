...
MY_APPS = [
    'my_apps.my_money.apps.MyMoneyConfig',
    'my_apps.accounts.apps.AccountsConfig',
    'my_apps.carpena.apps.CarpenaConfig',
]
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'static']  # donde tienes tus archivos estáticos de desarrollo
...
MESSAGE_TAGS = {
    ...
    messages.ERROR: 'danger',  # para usar estilo Bootstrap
}
